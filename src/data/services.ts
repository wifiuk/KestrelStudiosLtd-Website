...
export const services: Service[] = [
  ...
  },
  {
    ...
    heroImage: '/roof_1.webp',
    sectionImage: '/roof_2.webp',
    includes: [
  ...
  },
  {
    ...
    heroImage: '/construction_1.webp',
    sectionImage: '/construction_2.webp',
    includes: [
  ...
  },
  {
    ...
    heroImage: '/business_social_media_hero.webp',
    sectionImage: '/business_social_media_section.webp',
    includes: [
  ...
  {
    title: 'Land, Plot and Site Mapping',
    slug: 'land-plot-site-mapping',
    shortDescription: 'Aerial overviews, orthomosaic maps and site imagery for land, planning and development.',
    heroTitle: 'LAND, PLOT AND SITE MAPPING',
    highlightWord: 'MAPPING',
    summary: 'Aerial photography, video and orthomosaic mapping for land plots, development sites and planning contexts — showing boundaries, access, surroundings and site detail from above.',
    ...
    heroImage: '/land_overview_1.webp',
    sectionImage: '/land_mapping_2.webp',
    includes: [
      { title: 'Site Overview Imagery', description: 'Wide aerial photographs showing the full extent of the land, plot or site.' },
      ...
      { title: 'Progress Mapping', description: 'Repeat mapping visits to track site changes over time.' },
      { title: 'Exportable Outputs', description: 'Mapping outputs delivered in standard formats including GeoTIFF and JPEG for use in planning and GIS software.' },
    ],
    audience: [
      { name: 'Landowners', detail: 'Aerial visuals and maps to support land sales or planning applications.' },
      { name: 'Developers', detail: 'Site context, overview imagery and mapping for feasibility and marketing.' },
      { name: 'Estate Agents', detail: 'Standout aerial content and maps for land and plot listings.' },
      { name: 'Planning Consultants', detail: 'Visual context and orthomosaic outputs to support planning submissions.' },
      { name: 'Construction Firms', detail: 'Site mapping for progress tracking, documentation and reporting.' },
    ],
    deliverables: [
      ...
      { title: 'Orthomosaic Map', description: 'Single stitched overhead image of the full site at high resolution.', formats: ['GeoTIFF', 'JPEG'] },
  ...
  },
  {
    ...
    heroImage: '/rural_1.webp',
    sectionImage: '/rural_2.webp',
    includes: [
  ...
  {
    title: 'Tourism and Destination Visuals',
    slug: 'tourism-destination-visuals',
    shortDescription: 'Aerial photography and video for hotels, attractions, venues and destinations.',
    heroTitle: 'TOURISM AND DESTINATION VISUALS',
    ...
    heroImage: '/tourism_destination_hero.webp',
    sectionImage: '/tourism_destination_section.webp',
    includes: [
      ...
      { title: 'Grounds and Approach Coverage', description: 'Aerial views of entrances, car parks, gardens and outdoor spaces.' },
      { title: 'Seasonal Shoots', description: 'Repeat visits to capture your destination across different seasons.' },
      { title: 'Social Media Clips', description: 'Short-form aerial clips cut for Instagram, Facebook and TikTok.' },
      { title: 'Website and Brochure Imagery', description: 'Professionally edited stills and video ready for all marketing channels.' },
    ],
    audience: [
      { name: 'Hotels and B&Bs', detail: 'Showcase your setting and grounds to attract more bookings.' },
      { name: 'Visitor Attractions', detail: 'Aerial content for castles, gardens, vineyards and heritage sites.' },
      { name: 'Holiday Parks and Retreats', detail: 'Show off your site, facilities and surroundings from above.' },
      { name: 'Tourism Boards', detail: 'Destination content for regional and local tourism promotion.' },
      { name: 'Outdoor Venues', detail: 'Aerial imagery for golf courses, equestrian centres and rural venues.' },
    ],
    deliverables: [
      { title: 'Aerial Location Photos', description: 'Wide and detailed aerial images of the destination and its surroundings.', formats: ['JPEG', 'PNG'] },
      { title: 'Destination Showcase Video', description: 'Edited cinematic aerial video for websites, social media and marketing.', formats: ['MP4', '4K'] },
      { title: 'Social Media Clips', description: 'Short-form cuts in vertical and square formats ready to post.', formats: ['MP4', '9:16'] },
      { title: 'Raw Footage (Optional)', description: 'Unedited footage for clients with in-house editing teams.', formats: ['MOV', '4K'] },
    ],
  },
  {
    ...
    heroImage: '/3d_automated_mapping.webp',
    sectionImage: '/3d_mapping_measurements.webp',
  ...
  },
  {
    ...
    heroImage: '/stockpile_volume_hero.webp',
    sectionImage: '/stockpile_volume_section.webp',
    includes: [
